      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-[#a09890] max-w-xl mx-auto mb-8">Real customers, real jerseys, real satisfaction.</p>
            ...
            href="https://g.page/r/CYk4gyifupn8EBM/review"
            target="_blank"
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <a href="https://g.page/r/CYk4gyifupn8EBM/review" target="_blank" rel="noopener noreferrer"
              ...
              <Star size={16} fill="black" /> Leave a Review
            </a>
          </div>
        ) : (
