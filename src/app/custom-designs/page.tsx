    ...
    <div className="min-h-screen pt-24 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-8">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-black text-[#f0ede8] tracking-tight mb-4">Custom Designs</h1>
          <p className="text-[#5c5755] text-base max-w-xl mx-auto leading-relaxed">Every jersey tells a story. Browse our custom work and reach out to start yours.</p>
        </div>

        <div className="flex justify-center mb-14">
          <a href="https://instagram.com/JerseyWorldB" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-8 py-4 bg-[#c9a84c] text-[#111] font-bold rounded-xl hover:bg-[#dfc06e] transition-all duration-300 text-sm uppercase tracking-[0.1em]">
          ...
          <div className="columns-2 sm:columns-3 lg:columns-4 gap-3 sm:gap-4 space-y-3 sm:space-y-4">
            {designs.map((design: any) => (
              <div key={design.id} className="break-inside-avoid group relative overflow-hidden rounded-2xl border border-[#2e2d2d] hover:border-[#c9a84c44] transition-all duration-300">
                <img src={design.image_url} alt={design.caption ?? 'Custom design'} className="w-full block object-cover" />
                {design.caption && (
