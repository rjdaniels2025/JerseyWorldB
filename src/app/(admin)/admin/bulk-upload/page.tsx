...
const CATEGORY_SIZES: Record<string, string[]> = {
  '2026 World Cup': ['Kids XXS', 'Kids XS', 'Kids S', 'Kids M', 'Kids L', 'Kids XL', 'Kids 2XL', 'XS', 'S', 'M', 'L', 'XL', '2XL', '3XL', '4XL'],
  Soccer:     ['Kids XXS', 'Kids XS', 'Kids S', 'Kids M', 'Kids L', 'Kids XL', 'Kids 2XL', 'XS', 'S', 'M', 'L', 'XL', '2XL', '3XL', '4XL'],
